...
class ComidasControllerTest < ActionController::TestCase
  ...
  test "should create comida" do
    assert_difference('Comida.count') do
      post :create, comida: { description: @comida.description, img: @comida.img, menu_id: @comida.menu_id, name: @comida.name, price: @comida.price }
    end
  ...
  test "should update comida" do
    put :update, id: @comida, comida: { description: @comida.description, img: @comida.img, menu_id: @comida.menu_id, name: @comida.name, price: @comida.price }
    assert_redirected_to comida_path(assigns(:comida))
  end
